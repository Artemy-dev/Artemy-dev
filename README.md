...
Backend-разработчик на Python с практическим опытом разработки REST API, аутентификации и асинхронных сервисов. Основной фокус - проектирование серверной логики, работа с базами данных, кеширование и подготовка сервисов к продакшену. Автор полноценного backend-проекта цифрового магазина с реальной архитектурой и инфраструктурой.
